    ...
    <>
      ...
      >
        ...
        <ul className={`nav nav__burger ${isActive ? "active" : ""}`}>
          ...
          <li className="nav__item">
            <Link to="/legal" className="nav__item--link">
              Legal Notice
            </Link>
          </li>
          <li className="nav__item">
            <Link to="/privacy" className="nav__item--link">
              Privacy Policy
            </Link>
          </li>
          <li className="nav__item">
            <Link to="/cookies" className="nav__item--link">
              Cookie Policy
            </Link>
          </li>
          <li className="small accent-font copywright">
            Andrea Giménez 2023 <span className="main-font">©</span> All Rights
            Reserved.
          </li>
        </ul>
        <div className="nav__wrap">
          <ul className="nav nav--desktop">
            ...
            <li className="nav__item">
              <a href="/#projects" className="nav__item--link">
                Projects
              </a>
            </li>
            <li className="nav__item">
          ...
          >
            ...
            >
              ...
              <desc>
                Two horizontal lines, one above the other, the lower line is
